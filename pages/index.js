      ...
      <div className="text-white row px-5">
          <div className="col-md-8 col-sm-12">
            <div className={`${style.spanitem}`}>
              ...
              <span onClick={() => dispatch(changeTrending("movie"))}>Movies</span>
              <span onClick={() => dispatch(changeTrending("tv"))}>TV Shows</span>
              <span onClick={() => dispatch(changeTrending("person"))}>Person</span>
            </div>
